...
import { addItem } from '../../../Slices/cartSlice'; // Adjust import path as per your project structure
import './Men.css';
    ...
    <div>
      <>
        ...
        <div className='MenCollection'>
          <Section title="Popular Products" products={popularProducts} />
...
const popularProducts = [
  { id: 1, name: 'Brown shoes isolated', price: 700, image: Sneakers },
  { id: 2, name: 'Black leather', price: 500, image: Sneakers2 },
  { id: 3, name: 'Black leather isolated', price: 250, image: Sneakers3 },
  { id: 4, name: 'Brown leather slip', price: 450, image: Sneakers },
];
